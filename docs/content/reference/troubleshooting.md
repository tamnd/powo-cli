...
Most of these come down to network reality or how powo serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

powo rate-limits like any public site. powo already paces
...
Where a surface is gated, powo reads a cookie or token you supply
...
`powo`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what powo actually did
